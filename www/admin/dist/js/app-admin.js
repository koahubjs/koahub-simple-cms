        ...
        $(document).on("click", a + " li a", function (a) {
            ...
            if (e.is(".treeview-menu") && e.is(":visible"))e.slideUp(c, function () {
                ...
                e.slideDown(c, function () {
                    e.addClass("menu-open"),h.parent("ul").find("li.active").removeClass("active"),h.addClass("active"), b.layout.fix()
                })
            } else {
                $('.sidebar-menu .treeview-menu').find("li.active").removeClass("active");
                var h = d.parent("li");
                h.parent("ul").find("li.active").removeClass("active");
                h.addClass("active");
                b.layout.fix();
            }
